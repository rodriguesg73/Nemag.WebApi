...
namespace Nemag.Auxiliar.Email.Mime.Decode
{
    /// <summary>
    ...
    public static class EncodingFinder
	{
        ...
        /// using the <see cref="EncodingMap"/> or general code.<br/>
        ...
        public delegate System.Text.Encoding FallbackDecoderDelegate(string characterSet);
		...
		/// </summary>
        private static Dictionary<string, System.Text.Encoding> EncodingMap { get; set; }
        ...
        internal static System.Text.Encoding FindEncoding(string characterSet)
		{
			...
			try
			{
                ...
                return System.Text.Encoding.GetEncoding(characterSet);
			}
			catch (ArgumentException)
			{
                ...
                System.Text.Encoding fallbackDecoderResult = FallbackDecoder(characterSet);
        ...
        public static void AddMapping(string characterSet, System.Text.Encoding encoding)
		{
			if (characterSet == null)
				throw new ArgumentNullException("characterSet");
