...
using Nemag.Auxiliar.Email.Mime.Header;
using Nemag.Auxiliar.Email.Mime.Traverse;

namespace Nemag.Auxiliar.Email.Mime
{
    /// <summary>
    ...
    /// <br/>
    /// Use the <see cref="MessagePart"/> property to find the actual content of the email message.
    /// </summary>
    /// <example>
    ...
    public class Message
	{
        ...
        #region Constructors
        /// <summary>
        /// Convenience constructor for <see cref="Message(byte[], bool)"/>.<br/>
        /// <br/>
        ...
        /// The returned <see cref="MailMessage"/> can be used with <see cref="SmtpClient"/> to forward the email.<br/>
        /// <br/>
        /// You should be aware of the following about this method:
        /// <list type="bullet">
        /// <item>
        ///    All sender and receiver mail addresses are set.
        ///    If you send this email using a <see cref="SmtpClient"/> then all
        ...
        public MailMessage ToMailMessage()
		{
			...
			foreach (MessagePart textVersion in textVersions)
			{
                ...
                {
                    ContentId = textVersion.ContentId,
                    ContentType = textVersion.ContentType
                };
        ...
        /// <br/>
        /// <see cref="MessagePart.IsText"/> for MessageParts which are considered to be text versions.<br/>
        /// <br/>
        ...
        /// <br/>
        /// <see cref="MessagePart.IsAttachment"/> for MessageParts which are considered to be attachments.
        /// </summary>
