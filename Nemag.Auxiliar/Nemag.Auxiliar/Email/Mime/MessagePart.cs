...
using Nemag.Auxiliar.Email.Mime.Decode;
using Nemag.Auxiliar.Email.Mime.Header;
using Nemag.Auxiliar.Email.Common;
...
namespace Nemag.Auxiliar.Email.Mime
{
    ...
    public class MessagePart
	{
        ...
        /// to the default of <see cref="ContentTransferEncoding.SevenBit">SevenBit</see> in accordance to the RFC.
        /// </summary>
		...
		/// </summary>
        public System.Text.Encoding BodyEncoding { get; private set; }
        ...
        private static System.Text.Encoding ParseBodyEncoding(string characterSet)
		{
		...
		private static byte[] DecodeBody(byte[] messageBody, ContentTransferEncoding contentTransferEncoding)
		{
			...
			switch (contentTransferEncoding)
			{
				case ContentTransferEncoding.QuotedPrintable:
                    ...
                    return QuotedPrintable.DecodeContentTransferEncoding(System.Text.Encoding.ASCII.GetString(messageBody));

				case ContentTransferEncoding.Base64:
					// If encoded in Base64, everything in the body is in US-ASCII
                    return Base64.Decode(System.Text.Encoding.ASCII.GetString(messageBody));
