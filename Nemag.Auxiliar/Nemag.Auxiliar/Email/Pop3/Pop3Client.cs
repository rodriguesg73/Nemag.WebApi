...
using Nemag.Auxiliar.Email.Pop3.Exceptions;
using Nemag.Auxiliar.Email.Common;
using Nemag.Auxiliar.Email.Common.Logging;
using Nemag.Auxiliar.Email.Pop3.Pop3;
using Nemag.Auxiliar.Email.Mime;

namespace Nemag.Auxiliar.Email.Pop3
{
    /// <summary>
    ...
    public class Pop3Client : Disposable
	{
		...
		private static bool IsLastLineInMultiLineResponse(string lineReceived)
		{
			...
			// it is the last line
            return lineReceived.Length == 1 && IsLastLineInMultiLineResponse(System.Text.Encoding.ASCII.GetBytes(lineReceived));
		}
